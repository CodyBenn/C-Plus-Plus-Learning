...
int main()
{
    ...
    */
    ...
    //NOTE TO SELF: 
            //Describe what'd going to happen in std::strcat before you do the cat :
            //source is going to be appeneded to dest, and the process will start
            //by overriding the null character in dest

    std::cout << "std::strlen(dest1) : " << std::strlen(dest1) << std::endl;
    std::cout << "std::strlen(srouce1) : " << std::strlen(source1) << std::endl;
    ...
    */
    ...
    //signature : char *strncat( char *dest, const char *stc, std::size_t count);
    ...
    */
    ...
    std::cout << "dest 4 : " << dest4 << std::endl;
